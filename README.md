...
* **Seguridad Ofensiva y Defensiva:** Introducción al Hacking Ético y resolución de laboratorios en plataformas como **TryHackMe**, **HackTheBox** y **Atenea** (CCN-CERT).
* **Programación y Scripting:** Fundamentos de **Python** orientados a la automatización, SQL para gestión de bases de datos y estructuras HTML.
* **Gobernanza y Gestión:** Análisis de riesgos, marcos de trabajo (MITRE ATT&CK) y cumplimiento normativo en ciberseguridad.
